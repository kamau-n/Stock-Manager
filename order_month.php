...
$sql = "SELECT   * FROM order_items JOIN payment  on payment.payment_order_id =order_items.order_item_order_id join orders on orders.orders_id=order_items.order_item_order_id and MONTH(orders.orders_date)='$month';";
$results = $conn->query($sql);
$sql2 = "SELECT SUM(payment.payment_amount)as total FROM order_items JOIN payment  on payment.payment_order_id =order_items.order_item_order_id join orders on orders.orders_id=order_items.order_item_order_id and MONTH(orders.orders_date) ='$month'";
